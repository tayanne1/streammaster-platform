const filmes = [
  /* ========== deadpool 2 ========== */
  {
    ...
    trailer: {
      ...
      info: [
        ...
        {
          titulo: "Writers",
          valor: "Rhett Reese • Paul Wernick • Ryan Reynolds",
        },
        {
          titulo: "Languages Available",
          valor: "English, Portuguese (BR), Spanish, French",
        },
  ...
  /* ========== superman ========== */
  {
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Filming Locations",
          valor: "Atlanta (USA), Vancouver (Canada)",
        },
        { titulo: "Original Language", valor: "English" },
    ...
    resenha: {
      ...
      reviews: [
        ...
        },
        {
          ...
          texto:
            "Finally, a Superman with emotion and presence. I cried twice.",
        },
        {
          autor: "loislane4life",
  ...
  /* ========== sinners ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/iCgB8k7ftx4?si=Bw0SXR0Vc4acTU7z",
      info: [
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Um thriller intenso com elementos sobrenaturais e forte carga emocional.",
        },
        {
          autor: "IMDb Users",
          texto:
            "Visual impressionante e atuação excelente de Michael B. Jordan.",
        },
        {
          autor: "Crítica Geral",
  ...
  /* ========== peaky blinders: the immortal man ========== */
  {
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Setting",
          valor: "Birmingham, 1940 (Segunda Guerra Mundial)",
        },
        { titulo: "Original Language", valor: "English" },
      ...
      reviews: [
        {
          autor: "IMDb Users",
          texto:
            "Uma conclusão intensa e emocional para a história de Tommy Shelby.",
        },
        {
          autor: "Crítica Geral",
  ...
  /* ========== ready or not 2: here i come ========== */
  {
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Setting",
          valor: "Continuação direta após os eventos do primeiro filme",
        },
        { titulo: "Original Language", valor: "English" },
      ...
      reviews: [
        {
          autor: "Crítica Geral",
          texto:
            "Uma sequência mais ambiciosa que expande o universo do original.",
        },
        {
          autor: "Fans",
  ...
  /* ========== lucas ========== */
  {
    ...
    trailer: {
      ...
      info: [
        ...
        {
          titulo: "Languages Available",
          valor: "English, Portuguese (BR), Spanish, Italian",
        },
        { titulo: "Subtitles", valor: "Multiple languages" },
      ],
    },
    ...
    resenha: {
      ...
      reviews: [
        ...
        },
        {
          autor: "Fans",
          texto:
            "História simples, mas com uma mensagem poderosa sobre amizade.",
        },
        {
          autor: "Reviewers",
          texto:
            "Pixar entrega mais uma obra sensível e cheia de personalidade.",
        },
      ],
    },
  ...
  /* ========== project hail mary ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/uI1KofmBtYI?si=W4jYSMRPoKFMpJ6c",
      info: [
        { titulo: "Director", valor: "Phil Lord • Christopher Miller" },
        {
          titulo: "Writers",
          valor: "Drew Goddard • baseado no livro de Andy Weir",
        },
        { titulo: "Languages Available", valor: "English" },
        { titulo: "Subtitles", valor: "Multiple languages" },
      ],
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Based on",
          valor: "Livro de Andy Weir (autor de The Martian)",
        },
      ...
      reviews: [
        {
          ...
          texto:
            "Um dos filmes de ficção científica mais aguardados da década.",
        },
        {
          autor: "Fãs do livro",
  ...
  /* ========== one battle after another ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/lxGujG1uewY?si=gB1WPiXPt3chvqxv",
      info: [
  ...
  /* ========== hoppers ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/Og-N4WaGRMU?si=eFNsbWIsPbIaboKh",
      info: [
  ...
  /* ========== war machine ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/mBenb7O8Hnc?si=QoLldqvUe35yl4YM",
      info: [
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Locais de Filmagem",
          valor: "Victoria (Austrália), Los Angeles (EUA)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
      ...
      reviews: [
        {
          ...
          texto:
            "Uma experiência visceral. Alan Ritchson prova que é a próxima grande estrela de ação.",
        },
        {
        ...
        },
        {
          autor: "Marcos_Filmes",
          texto:
            "Finalmente um filme militar que foca no aspecto psicológico além dos tiros.",
        },
        {
        ...
        },
        {
          autor: "ana_cine",
          texto:
            "Tenso, barulhento e emocionante. Assista na maior tela possível!",
        },
        {
  ...
  /* ========== reminders of him ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/PgyVVyHT4Zs?si=9w4yJRagopk_khgg",
      info: [
        { titulo: "Diretor", valor: "Isaac Aptaker" },
        {
          titulo: "Escritores",
          valor: "Colleen Hoover (Livro) • Elizabeth Berger",
        },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Espanhol",
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Locais de Filmagem",
          valor: "Utah (EUA), Los Angeles (EUA)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
      ...
      reviews: [
        {
          ...
          texto:
            "Uma adaptação extremamente fiel e emocionante. Preparem os lenços.",
        },
        {
          autor: "Cinema com Afeto",
          texto:
            "Maika Monroe entrega uma atuação crua e vulnerável que te prende do início ao fim.",
        },
        {
          autor: "DramaDaily",
          texto:
            "A química entre Maika e Dacre Montgomery é o coração deste filme.",
        },
        {
          autor: "Crítica_Indie",
          texto:
            "Uma história sobre perdão e redenção que não foge dos momentos difíceis.",
        },
        {
          autor: "user_booklover",
          texto:
            "Eu li o livro três vezes e o filme conseguiu capturar exatamente o que senti.",
        },
        {
          autor: "carol_cine",
          texto:
            "Kenna Rowan é uma das personagens mais complexas que vi em um romance recentemente.",
        },
        {
          autor: "obsessed_fan",
  ...
  /* ========== avatar ========== */
  {
    ...
    trailer: {
      ...
      info: [
        ...
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Espanhol, Chinês",
        },
    ...
    sobre: {
      info: [
        {
          titulo: "Estúdio",
          valor: "20th Century Fox • Lightstorm Entertainment",
        },
        { titulo: "Franquia", valor: "Avatar Saga" },
        {
          titulo: "Locais de Filmagem",
          valor: "Nova Zelândia, Califórnia (EUA)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Uma revolução visual que mudou a forma como vemos o cinema em 3D.",
        },
        {
          autor: "Omelete",
          texto:
            "James Cameron cria um ecossistema inteiro que parece vivo e pulsante.",
        },
        {
          autor: "Cine_Master",
          texto:
            "A história é clássica, mas a execução e o mundo de Pandora são inigualáveis.",
        },
        {
          autor: "SciFi_World",
          texto:
            "Visualmente deslumbrante. Um marco para os efeitos especiais modernos.",
        },
        {
          autor: "user_pandora_fan",
          texto:
            "Eu assisti 5 vezes no cinema e ainda choro no final. Neytiri é incrível.",
        },
        {
          autor: "tech_guru",
          texto:
            "O nível de detalhe nas texturas e iluminação ainda impressiona hoje.",
        },
        {
          autor: "marcos_viana",
          texto:
            "Uma experiência imersiva que todos deveriam ter pelo menos uma vez.",
        },
      ],
    },
  ...
  /* ========== vingadores: ultimato ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/spJoZReeIeQ?si=MTAVlhZCE30NUnm0",
      info: [
        { titulo: "Diretores", valor: "Anthony Russo • Joe Russo" },
        {
          titulo: "Roteiristas",
          valor: "Christopher Markus • Stephen McFeely",
        },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Espanhol, Japonês",
        },
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Franquia",
          valor: "Universo Cinematográfico Marvel (Saga do Infinito)",
        },
        {
          titulo: "Locais de Filmagem",
          valor: "Atlanta (EUA), Edimburgo (Escócia)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
      ...
      reviews: [
        {
          autor: "Omelete",
          texto:
            "O maior evento cinematográfico da nossa geração. Um tributo perfeito aos fãs.",
        },
        {
          autor: "CinePOP",
          texto:
            "Emocionante, épico e visualmente impecável. O fechamento de um ciclo inesquecível.",
        },
        {
          autor: "AdoroCinema",
          texto:
            "Não é apenas um filme de super-herói, é um marco na história da cultura pop.",
        },
        {
          autor: "marvelfan_br",
          texto:
            "Eu te amo 3000. Chorei do começo ao fim, melhor experiência no cinema.",
        },
        {
          autor: "geek_master",
          texto:
            "A batalha final é a coisa mais épica que já vi em uma tela de cinema.",
        },
        {
          autor: "luiza_cine",
          texto:
            "Roteiro amarrado com perfeição. Cada personagem teve seu momento de brilhar.",
        },
        {
          autor: "thor_lover",
          texto:
            "O arco de encerramento do Capitão e do Homem de Ferro foi digno de lendas.",
        },
      ],
    },
  ...
  /* ========== titanic ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/IH6_CA_ocqY?si=xb3fwgsuHHctSKqx",
      info: [
        { titulo: "Diretor", valor: "James Cameron" },
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Locais de Filmagem",
          valor: "Rosarito (México), Vancouver (Canadá)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Um épico atemporal que equilibra perfeitamente o desastre histórico com um romance inesquecível.",
        },
        {
          autor: "Folha Ilustrada",
          texto:
            "A química entre DiCaprio e Winslet é o que torna este filme um clássico eterno.",
        },
        {
          autor: "CineGeral",
          texto:
            "Efeitos visuais que, mesmo décadas depois, ainda superam muitas produções atuais.",
        },
        {
          autor: "user_rose_jack",
          texto:
            "Eu nunca vou superar o fato de que os dois cabiam naquela porta!",
        },
        {
          autor: "cinema_lover",
          texto:
            "Assisti mil vezes e choro nas mil vezes. A trilha sonora é perfeita.",
        },
        {
          autor: "historico_nerd",
          texto:
            "A atenção aos detalhes na reconstrução do navio é simplesmente fenomenal.",
        },
        {
          autor: "marcos_antonio",
          texto:
            "O tipo de filme que define o que é a experiência de ir ao cinema.",
        },
      ],
    },
  ...
  /* ========== avatar 2 ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/x5pZI-DmtrE?si=DEawgABb9FdlmZKW",
      info: [
        { titulo: "Diretor", valor: "James Cameron" },
        {
          titulo: "Escritores",
          valor: "James Cameron • Rick Jaffa • Amanda Silver",
        },
        {
          titulo: "Idiomas Disponíveis",
    ...
    sobre: {
      info: [
        {
          titulo: "Estúdio",
          valor: "20th Century Studios • Lightstorm Entertainment",
        },
        { titulo: "Franquia", valor: "Avatar Saga" },
      ...
      reviews: [
        {
          autor: "Omelete",
          texto:
            "Visualmente o filme mais impressionante já feito. James Cameron é um mestre da imersão.",
        },
        {
          autor: "G1 Cinema",
          texto:
            "Uma jornada emocional profunda que expande o universo de Pandora de forma magnífica.",
        },
        {
          autor: "CinePop",
          texto:
            "Valeu cada segundo da espera. A conexão com a natureza e os novos clãs é fascinante.",
        },
        {
          autor: "user_navi_life",
          texto:
            "O visual dos Metkayina e as criaturas marinhas são de cair o queixo. Chorei muito.",
        },
        {
          autor: "nerd_expert",
          texto:
            "A tecnologia de CGI aqui está anos-luz à frente de qualquer outro estúdio.",
        },
        {
          autor: "clara_cine",
          texto:
            "É longo, mas você nem sente o tempo passar. É como visitar outro planeta.",
        },
        {
          autor: "filme_review",
          texto:
            "Jake e Neytiri como pais trouxe uma camada de maturidade que a franquia precisava.",
        },
      ],
    },
  ...
  /* ========== vingadores: guerra infinita ========== */
  {
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Locais de Filmagem",
          valor: "Edimburgo (Escócia), Atlanta (EUA)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
        { titulo: "Distribuição", valor: "Disney+ • Marvel" },
      ],
      ...
      reviews: [
        {
          autor: "Omelete",
          texto:
            "O vilão mais impactante da Marvel. Thanos é uma força da natureza que não pode ser ignorada.",
        },
        {
          autor: "CinePOP",
          texto:
            "Um ritmo frenético que não deixa você respirar. O final é um dos momentos mais chocantes do cinema.",
        },
        {
          autor: "AdoroCinema",
          texto:
            "Equilibrar tantos personagens de forma tão orgânica é um feito hercúleo dos irmãos Russo.",
        },
        {
          autor: "marvelfan99",
        ...
        },
        {
          autor: "nerd_news",
          texto:
            "A interação entre os Guardiões da Galáxia e os Vingadores é simplesmente ouro puro.",
        },
        {
          autor: "ana_vitoria",
          texto:
            "Visualmente perfeito e emocionalmente devastador. É o melhor filme do MCU.",
        },
        {
          autor: "thor_god",
          texto:
            "A entrada do Thor em Wakanda é a cena mais épica da história dos super-heróis.",
        },
      ],
    },
  ...
  /* ========== home-aranha: sem volta para casa ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/bHzGeci_8wc?si=r_TBMJ1NKGg8LqWD",
      info: [
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Franquia",
          valor: "Universo Cinematográfico Marvel (Homem-Aranha)",
        },
        {
          titulo: "Locais de Filmagem",
          valor: "Atlanta (EUA), Nova York (EUA)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
      ...
      reviews: [
        {
          autor: "Omelete",
          texto:
            "Uma carta de amor ao legado do Homem-Aranha no cinema. Épico e emocionante.",
        },
        {
          autor: "AdoroCinema",
          texto:
            "A melhor performance de Tom Holland como Peter Parker. Willem Dafoe rouba a cena.",
        },
        {
          autor: "CinePOP",
          texto:
            "Um evento cinematográfico que recompensa décadas de fidelidade dos fãs.",
        },
        {
          autor: "spidey_fan_br",
          texto:
            "Eu gritei e chorei no cinema. A melhor experiência que já tive com a Marvel.",
        },
        {
          autor: "nerd_verso",
          texto:
            "O roteiro consegue equilibrar nostalgia com uma história genuinamente importante para o Peter.",
        },
        {
          autor: "carla_oliveira",
          texto:
            "As cenas de luta e o peso emocional das perdas tornam este filme único.",
        },
        {
          autor: "multiverse_lover",
          texto:
            "Finalmente vimos o potencial total do Aranha de Tom Holland. Incrível.",
        },
      ],
    },
  ...
  /* ========== o rei leao ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/qRbjMur9Xjo?si=573tp-jLP_-fkq2l",
      info: [
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Prêmios",
          valor: "Vencedor de 2 Oscars (Trilha Sonora e Canção)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
        { titulo: "Distribuição", valor: "Disney+" },
      ],
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "A obra-prima máxima da Disney. Um roteiro shakespeariano com animação impecável.",
        },
        {
          autor: "Folha de SP",
          texto:
            "A trilha sonora de Elton John e Hans Zimmer é o coração pulsante deste épico africano.",
        },
        {
          autor: "CinePop",
          texto:
            "O ciclo da vida nunca foi tão bem representado. Um filme que transcende gerações.",
        },
        {
          autor: "nostalgia_fan",
          texto:
            "Assisti na infância e hoje meus filhos amam. Simba é um ícone eterno.",
        },
        {
          autor: "critico_geek",
          texto:
            "Scar continua sendo um dos vilões mais complexos e sinistros da história da animação.",
        },
        {
          autor: "bruno_p",
          texto:
            "O início do filme com 'Circle of Life' é arrepiante até hoje. Cinema puro.",
        },
        {
          autor: "disney_lover",
          texto:
            "Hakuna Matata é o lema da minha vida. Timão e Pumba são o melhor alívio cômico!",
        },
      ],
    },
  ...
  /* ========== velozes e furiosos 7 ========== */
  {
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Locais de Filmagem",
          valor: "Abu Dhabi (EAU), Atlanta (EUA), Colorado (EUA)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Uma despedida emocionante e honrosa para Paul Walker. Ação de tirar o fôlego.",
        },
        {
          autor: "Omelete",
          texto:
            "James Wan traz um frescor visual para a série, elevando as cenas de luta e perseguição.",
        },
        {
          autor: "CinePOP",
          texto:
            "Impossível não se emocionar com os minutos finais. É mais do que apenas carros, é sobre família.",
        },
        {
          autor: "speed_demon_br",
          texto:
            "A sequência em Abu Dhabi com o Lykan Hypersport saltando entre prédios é lendária!",
        },
        {
          autor: "paul_walker_fan",
          texto:
            "See You Again me faz chorar toda vez. Um tributo perfeito para o nosso Brian.",
        },
        {
          autor: "ricardo_filmes",
          texto:
            "Vilão incrível. Jason Statham trouxe uma ameaça real que a equipe nunca tinha enfrentado.",
        },
        {
          autor: "geek_auto",
          texto:
            "O equilíbrio entre a ação absurda e o drama pessoal foi o ponto alto deste filme.",
        },
      ],
    },
  ...
  /* ========== frozen ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/Dx7lpHWUTTE?si=wlf1x0dDba8sLDmy",
      info: [
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Prêmios",
          valor: "Vencedor de 2 Oscars (Melhor Animação e Canção Original)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
        { titulo: "Distribuição", valor: "Disney+" },
      ],
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Uma das melhores animações da Disney. Desconstrói o clichê do 'príncipe encantado' com maestria.",
        },
        {
          autor: "CinePop",
          texto:
            "Um fenômeno cultural. As músicas são viciantes e a história de amor fraternal é tocante.",
        },
        {
          autor: "Omelete",
          texto:
            "Visualmente deslumbrante, especialmente nas cenas em que Elsa usa seus poderes.",
        },
        {
          autor: "disney_nerd_99",
          texto:
            "Eu já vi esse filme 50 vezes e nunca canso de cantar Let It Go a plenos pulmões!",
        },
        {
          autor: "mãe_de_duas",
          texto:
            "Amei como o filme foca no poder da amizade entre irmãs. Minhas filhas adoram o Olaf.",
        },
        {
          autor: "geek_reviewer",
          texto:
            "A reviravolta do vilão foi uma das mais surpreendentes da história da Disney.",
        },
        {
          autor: "critico_musical",
          texto:
            "A trilha sonora é impecável. Cada canção ajuda a desenvolver os personagens perfeitamente.",
        },
      ],
    },
  ...
  /* ========== barbie ========== */
  {
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Prêmios",
          valor: "Vencedor de 1 Oscar (Melhor Canção Original)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
      ...
      reviews: [
        {
          autor: "Omelete",
          texto:
            "Inteligente, satírico e visualmente impecável. Greta Gerwig entregou muito mais que um filme de boneca.",
        },
        {
          autor: "AdoroCinema",
          texto:
            "Margot Robbie nasceu para esse papel, mas Ryan Gosling como Ken é a alma cômica do filme.",
        },
        {
          autor: "CinePOP",
          texto:
            "Um roteiro profundo que aborda temas existenciais com leveza e muito rosa. Inesquecível.",
        },
        {
          autor: "barbie_fan_br",
          texto:
            "Eu chorei com o monólogo da America Ferrera. O filme entende o que é ser mulher hoje.",
        },
        {
          autor: "geek_reviewer",
          texto:
            "A trilha sonora da Dua Lipa e Billie Eilish é simplesmente perfeita para o tom do filme.",
        },
        {
          autor: "ken_energy_23",
          texto:
            "Eu sou apenas Ken! A coreografia de I'm Just Ken é a melhor coisa que vi no cinema esse ano.",
        },
        {
          autor: "critico_indie",
          texto:
            "Uma obra de arte que consegue equilibrar o comercial com o autoral de forma brilhante.",
        },
      ],
    },
  ...
  /* ========== super mario bros. o filme  ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/cDNkh5WybZo?si=LX6ukmxkdP_izw13",
      info: [
    ...
    sobre: {
      info: [
        ...
        { titulo: "Franquia", valor: "Super Mario" },
        {
          ...
          valor: "Paris (França), Califórnia (EUA)",
        },
      ...
      reviews: [
        {
          autor: "Omelete",
          texto:
            "Uma carta de amor aos videogames. Visualmente vibrante e extremamente divertido para todas as idades.",
        },
        {
          autor: "NerdBunker",
          texto:
            "A Illumination acertou em cheio no tom. Peach como uma líder forte foi uma das melhores mudanças.",
        },
        {
          autor: "AdoroCinema",
          texto:
            "Nostalgia pura. Ver a Rainbow Road e as mecânicas dos jogos na tela grande foi um sonho realizado.",
        },
        {
          autor: "nintendo_fan_br",
          texto:
            "O Bowser do Jack Black é simplesmente a melhor coisa que aconteceu ao cinema em 2023!",
        },
        {
          autor: "gamer_girl",
          texto:
            "Eu procurei easter eggs o filme todo. A trilha sonora adaptada dos jogos é de arrepiar.",
        },
        {
          autor: "papai_geek",
          texto:
            "Levei meus filhos e não sei quem se divertiu mais. Um filme leve, rápido e muito bonito.",
        },
        {
          autor: "critico_vj",
          texto:
            "Finalmente uma adaptação de jogo que respeita a essência do material original.",
        },
      ],
    },
  ...
  /* ========== harry potter e as relíquias da morte: parte 2 ========== */
  {
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Locais de Filmagem",
          valor: "Londres (Reino Unido), Escócia",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Um desfecho magistral para a maior saga de fantasia do cinema moderno. Emocionante do início ao fim.",
        },
        {
          autor: "Omelete",
          texto:
            "A performance de Alan Rickman como Snape neste filme é digna de todos os prêmios possíveis.",
        },
        {
          autor: "CinePOP",
          texto:
            "O confronto final entre Harry e Voldemort é visualmente espetacular e carregado de peso emocional.",
        },
        {
          autor: "potterhead_99",
          texto:
            "Eu chorei na cena das memórias do Snape e não parei até os créditos subirem. Sempre.",
        },
        {
          autor: "geek_expert",
          texto:
            "Roteiro muito bem adaptado, conseguiram dar um fechamento digno para cada personagem querido.",
        },
        {
          autor: "bruxo_br",
          texto:
            "A trilha sonora do Alexandre Desplat traz uma urgência e uma tristeza que definem perfeitamente o filme.",
        },
        {
          autor: "ana_clara_cine",
          texto:
            "O final perfeito para a minha infância. Hogwarts será sempre nosso lar.",
        },
      ],
    },
  ...
  /* ========== interestelar ========== */
  {
    ...
    sobre: {
      info: [
        {
          titulo: "Estúdio",
          valor: "Paramount Pictures • Warner Bros. • Legendary",
        },
        {
          titulo: "Consultoria Científica",
          valor: "Kip Thorne (Físico Teórico)",
        },
        {
          titulo: "Locais de Filmagem",
          valor: "Islândia, Alberta (Canadá), Califórnia (EUA)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
        { titulo: "Distribuição", valor: "Max (HBO) • Prime Video" },
      ],
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Uma experiência cinematográfica transcendental. Nolan equilibra física quântica com emoção humana pura.",
        },
        {
          autor: "Omelete",
          texto:
            "Visualmente arrebatador e com uma das melhores trilhas sonoras da história do cinema.",
        },
        {
          autor: "CinePOP",
          texto:
            "Um filme que te faz questionar o tempo, o espaço e a força do amor. Obrigatório.",
        },
        {
          autor: "astronomy_fan",
          texto:
            "A cena de acoplagem com a trilha 'No Time for Caution' é a coisa mais tensa que já vi.",
        },
        {
          autor: "murph_lover",
          texto:
            "Eu nunca mais consegui ouvir o tique-taque de um relógio da mesma forma. Chorei demais.",
        },
        {
          autor: "nerd_expert",
          texto:
            "Roteiro complexo, mas extremamente gratificante. Cada detalhe importa para o final.",
        },
        {
          autor: "marcos_viana",
          texto:
            "McConaughey entrega a melhor atuação de sua carreira na cena das mensagens de vídeo.",
        },
      ],
    },
  ...
  /* ========== minions ========== */
  {
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Local de Produção",
          valor: "Paris (França), Santa Monica (EUA)",
        },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Uma comédia caótica e extremamente visual. Bob, Kevin e Stuart provam que têm carisma para brilhar sozinhos.",
        },
        {
          autor: "Omelete",
          texto:
            "O humor 'slapstick' funciona perfeitamente. É impossível não rir com a inocência destrutiva desses seres amarelos.",
        },
        {
          autor: "CinePop",
          texto:
            "A trilha sonora repleta de clássicos dos anos 60 traz um charme especial para a aventura em Londres.",
        },
        {
          autor: "banana_lover_99",
          texto:
            "Bananãaaa! O Bob é a coisa mais fofa que já vi em uma animação. Ri do começo ao fim.",
        },
        {
          autor: "geek_reviewer",
          texto:
            "Scarlet Overkill é uma vilã divertida, mas o show é realmente dos Minions. Diversão garantida para a família.",
        },
        {
          autor: "papai_coruja",
          texto:
            "Meus filhos amam e eu também me divirto com as referências históricas e as trapalhadas deles.",
        },
        {
          autor: "critico_vj",
          texto:
            "A animação da Illumination continua impecável, com cores vibrantes e um ritmo frenético.",
        },
      ],
    },
  ...
  /* ========== toy story 4 ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/76CslX-q57Mhttps://www.youtube.com/embed/76CslX-q5C4?si=T50oebbd6E78j9jm",
      info: [
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Uma conclusão (ou novo começo) visualmente deslumbrante que prova que a Pixar ainda tem fôlego para essa franquia.",
        },
        {
          autor: "Omelete",
          texto:
            "Garfinho é o melhor acréscimo em anos. A crise existencial de um talher é hilária e profunda.",
        },
        {
          autor: "CinePop",
          texto:
            "O final é emocionante e corajoso. Encerra o arco do Woody de uma forma que ninguém esperava.",
        },
        {
          autor: "pixar_fan_br",
          texto:
            "Eu achei que não precisava de um quarto filme, mas saí do cinema chorando e querendo ver de novo.",
        },
        {
          autor: "mãe_geek",
          texto:
            "Duke Caboom é o melhor personagem do filme! 'Yes I Can!'. Meus filhos riram demais.",
        },
        {
          autor: "nerd_expert",
          texto:
            "A iluminação e as texturas deste filme estão em outro nível. Parece real em vários momentos.",
        },
        {
          autor: "bruno_p_critico",
          texto:
            "Betty roubou o show. Ver a evolução dela de um abajur para uma heroína de ação foi fantástico.",
        },
      ],
    },
  ...
  /* ========== oppenheimer ========== */
  {
    ...
    trailer: {
      ...
      info: [
        ...
        {
          titulo: "Escritor",
          valor: "Christopher Nolan • Kai Bird • Martin J. Sherwin",
        },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Espanhol, Francês",
    ...
    sobre: {
      info: [
        {
          titulo: "Estúdio",
          valor: "Universal Pictures • Syncopy • Atlas Entertainment",
        },
        {
          titulo: "Prêmios",
          valor: "Vencedor de 7 Oscars, incluindo Melhor Filme e Diretor",
        },
        {
          titulo: "Locais de Filmagem",
          valor: "Novo México (EUA), Nova Jersey (EUA)",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
        { titulo: "Distribuição", valor: "Max (HBO) • Prime Video" },
      ],
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Uma obra-prima técnica e narrativa. Nolan redefine o gênero de cinebiografia com uma tensão constante.",
        },
        {
          autor: "Omelete",
          texto:
            "Cillian Murphy entrega a atuação de uma vida. O design de som é tão poderoso que você sente as explosões na alma.",
        },
        {
          autor: "CinePOP",
          texto:
            "O julgamento final e o conflito político são tão empolgantes quanto a própria criação da bomba.",
        },
        {
          autor: "historia_nerd_99",
          texto:
            "O realismo histórico e a cinematografia em IMAX preto e branco são simplesmente de outro nível.",
        },
        {
          autor: "ana_clara_cine",
          texto:
            "Três horas que passam voando. A trilha sonora do Ludwig Göransson é hipnotizante e agoniante ao mesmo tempo.",
        },
        {
          autor: "geek_reviewer",
          texto:
            "A química entre Robert Downey Jr. e Cillian Murphy no ato final é cinema em seu estado mais puro.",
        },
        {
          autor: "critico_vj",
          texto:
            "Oppenheimer não é apenas um filme sobre a bomba, mas sobre as consequências morais que mudaram o mundo para sempre.",
        },
      ],
    },
  ...
  /* ========== matrix ========== */
  {
    ...
    sobre: {
      info: [
        {
          titulo: "Estúdio",
          valor: "Warner Bros. • Village Roadshow • Silver Pictures",
        },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Um marco na história do cinema. Mudou para sempre a forma como filmes de ação e ficção científica são feitos.",
        },
        {
          autor: "Omelete",
          texto:
            "Mais do que efeitos especiais, Matrix traz uma discussão filosófica profunda sobre realidade e controle.",
        },
        {
          autor: "CinePOP",
          texto:
            "Visualmente icônico. O figurino de couro preto e os óculos escuros definiram uma era da cultura pop.",
        },
        {
          autor: "nerd_expert_99",
          texto:
            "Eu já vi este filme dezenas de vezes e sempre descubro um detalhe novo no código da Matrix.",
        },
        {
          autor: "sci_fi_lover",
          texto:
            "A cena do Neo desviando das balas no telhado é a sequência mais épica da história do cinema.",
        },
        {
          autor: "bruno_p_critico",
          texto:
            "Hugo Weaving entrega um dos vilões mais intimidadores de todos os tempos. O Agente Smith é inesquecível.",
        },
        {
          autor: "ana_clara_cine",
          texto:
            "O filme envelheceu como vinho. Os temas de tecnologia e vigilância são mais atuais do que nunca.",
        },
      ],
    },
  ...
  /* ========== john wick: de volta ao jogo ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/rQWw4BaV9z0?si=S82vf70D9Sx5OdJ_",
      info: [
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Um sopro de vida para os filmes de ação modernos. Coreografias impecáveis e um estilo visual único.",
        },
        {
          autor: "Omelete",
          texto:
            "Keanu Reeves nasceu para interpretar o 'Bicho-Papão'. Simples, direto e extremamente satisfatório.",
        },
        {
          autor: "CinePOP",
          texto:
            "O mundo dos assassinos e o Hotel Continental criam uma mitologia fascinante que vai muito além da vingança.",
        },
        {
          autor: "ação_lover_br",
          texto:
            "Nunca mexa com o cachorro de um homem que não tem nada a perder. Épico!",
        },
        {
          autor: "nerd_expert",
          texto:
            "As cenas no clube Red Circle são uma aula de direção de ação e iluminação neon.",
        },
        {
          autor: "marcos_viana",
          texto:
            "O ritmo do filme é perfeito. Não há gordura, apenas ação pura e bem executada.",
        },
        {
          autor: "geek_reviewer",
          texto:
            "John Wick redefiniu o gênero. Agora todo filme de ação quer ser como ele.",
        },
      ],
    },
  ...
  /* ========== pânico 7 ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/1jHkIGr3auA?si=gYFNV-6d52adis3k",
      info: [
    ...
    sobre: {
      info: [
        {
          titulo: "Estúdio",
          valor: "Spyglass Media Group • Paramount Pictures",
        },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "O retorno de Sidney Prescott é o que os fãs precisavam. A nostalgia está mais viva do que nunca.",
        },
        {
          autor: "Omelete",
          texto:
            "Kevin Williamson na direção traz uma segurança de que a essência de Pânico será respeitada.",
        },
        {
          autor: "CinePOP",
          texto:
            "Ghostface nunca pareceu tão perigoso. O clima de 'conclusão épica' domina a produção.",
        },
        {
          autor: "ghostface_fan_br",
          texto:
            "Sidney está de volta! Mal posso esperar para ver como as novas regras do terror vão funcionar.",
        },
        {
          autor: "horror_geek",
          texto:
            "A franquia Pânico é a única que consegue se manter relevante por décadas. Ansiedade a mil.",
        },
        {
          autor: "slasher_lover",
          texto:
            "Patrick Dempsey voltando como Detetive Kincaid é o fanservice que eu pedi aos céus.",
        },
        {
          autor: "critico_terror",
          texto:
            "Esperamos que este capítulo feche com chave de ouro o legado de Sidney Prescott.",
        },
      ],
    },
