const series = [
  /* ========== fallout ==========*/
  {
    ...
    titulo: "Fallout",
    tipo: "serie",
    imagem: "assets/img/series/fallout.jpg",
    capa: "assets/img/capas-series/fallout-capa.jpg",
    tempo: "1 Temporada",
    ano: "2024",
    genero: ["Ação", "Aventura", "Sci-Fi", "Drama"],
    dataGenre: "sci-fi acao aventura drama",
    linkPlataforma:
      "https://www.primevideo.com/detail?gti=amzn1.dv.gti.220a83cb-b9b4-4cad-b8a0-e768bb603fa7&irclickid=6e295544N59f811f1a4259bd2328cca6&ref=dvm_ass_acm_xx_mf_s_imp_6e295544N59f811f1a4259bd2328cca6&irgwc=1&afsrc=1",
    descricao:
    ...
    trailer: {
      url: "https://www.youtube.com/embed/7h8zJHywjAw?si=5IN87lhyi8kWhFv_",
      info: [
        {
          titulo: "Criadores",
          valor: "Graham Wagner • Geneva Robertson-Dworet",
        },
        { titulo: "Produtores Executivos", valor: "Jonathan Nolan • Lisa Joy" },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Espanhol, Alemão",
        },
      ...
      reviews: [
        {
          autor: "IGN Brasil",
          texto:
            "A melhor adaptação de um videogame já feita. Captura perfeitamente o tom de humor ácido e violência dos jogos.",
        },
        {
          autor: "Omelete",
          texto:
            "Ella Purnell e Walton Goggins estão incríveis. Uma série que agrada fãs e novatos.",
        },
        {
          autor: "vault_dweller_76",
          texto:
            "Os detalhes dos cenários, os Pip-Boys e as Power Armors são idênticos aos dos jogos. Nota 10!",
        },
      ],
    },
  ...
  /* ========== arcane ========== */
  {
    ...
    titulo: "Arcane",
    tipo: "serie",
    imagem: "assets/img/series/arcane.jpg",
    capa: "assets/img/capas-series/arcane-capa.jpg",
    tempo: "2 Temporadas",
    ano: "2021",
    ...
    trailer: {
      ...
      info: [
        ...
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Espanhol, Francês, Japonês",
        },
        { titulo: "Legendas", valor: "30+ idiomas" },
      ],
    },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Visualmente arrebatadora. Arcane eleva o padrão das animações para um nível quase inalcançável.",
        },
        {
          autor: "Omelete",
          texto:
            "Uma tragédia shakespeariana moderna. O desenvolvimento da relação entre Vi e Jinx é doloroso e brilhante.",
        },
        {
          autor: "zaun_rebel",
          texto:
            "Silco é um dos melhores vilões já escritos. Eu não esperava sentir empatia por ele.",
        },
      ],
    },
  ...
  /* ========== peaky blinders ========== */
  {
    ...
    tipo: "serie",
    popular: true,
    imagem: "assets/img/series/peaky-blinders.jpg",
    capa: "assets/img/capas-series/peakyblinderscapa1.jpg",
    tempo: "6 Temporadas",
    ano: "2013 - 2022",
    ...
    trailer: {
      ...
      info: [
        ...
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Espanhol",
        },
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Local de Produção",
          valor: "Birmingham, Liverpool, Manchester (UK)",
        },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Uma aula de estilo, atuação e roteiro. Cillian Murphy entrega uma das melhores performances da TV.",
        },
        {
          autor: "Omelete",
          texto:
            "A trilha sonora anacrônica e a fotografia impecável tornam Peaky Blinders uma experiência única.",
        },
        {
          autor: "shelby_fan_br",
          texto:
            "Frio e calculista! A evolução do Tommy de um gângster de rua para um político é brilhante.",
        },
      ],
    },
  ...
  /* ========== dark ========== */
  {
    ...
    tipo: "serie",
    popular: true,
    imagem: "assets/img/series/dark.jpg",
    capa: "assets/img/capas-series/dark-capa.jpg",
    tempo: "3 Temporadas",
    ano: "2017 - 2020",
    ...
    trailer: {
      url: "https://www.youtube.com/embed/ESEUoa-mz2c?si=sWSmgrxizekrSBKI",
      info: [
        { titulo: "Criadores", valor: "Baran bo Odar • Jantje Friese" },
        { titulo: "Idioma Original", valor: "Alemão" },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Alemão, Português (BR), Inglês, Espanhol",
        },
        { titulo: "Legendas", valor: "30+ idiomas" },
      ],
    },
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Local de Produção",
          valor: "Berlim, Brandemburgo (Alemanha)",
        },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Um quebra-cabeça brilhante. Dark exige atenção total e recompensa o espectador com uma trama impecável.",
        },
        {
          autor: "Omelete",
          texto:
            "A melhor série de ficção científica da Netflix. Atmosférica, sombria e filosoficamente profunda.",
        },
        {
          autor: "time_travel_geek",
          texto:
            "O final é perfeito. Tudo se encaixa de uma forma que te deixa pensando por dias.",
        },
      ],
    },
  ...
  /* ========== you ========== */
  {
    ...
    tipo: "serie",
    popular: true,
    imagem: "assets/img/series/you.jpg",
    capa: "assets/img/capas-series/you-capa.jpg",
    tempo: "4 Temporadas",
    ano: "2018 - Present",
    ...
    temporadas_detalhes: [
      ...
      },
      {
        ...
        capitulos: [
          ...
          "Apenas o Joe",
          "O Que São Amigos?",
          "O Bom, o Mau e o Hendy",
          "O Fim de Semana do Bem-Estar",
          "Adeus, Minha Coelhinha",
          "Crise de Identidade",
          "Pavor e Delírio em Beverly Hills",
          "Joe Goldberg é um Homem de Sorte",
          "Amor de Verdade",
        ],
      },
      {
        ...
        capitulos: [
          ...
          "A Síndrome da Mulher Desaparecida",
          "O Clube da Luta de Madre Linda",
          "Noite de Caça",
          "Wombat",
      ...
      },
      {
        ...
        capitulos: [
          ...
          "A Raposa e o Cão",
          "Melhor Amigo",
          "Bom Homem, Mundo Cruel",
          "Cadê você, Joe?",
          "Ela não está lá",
          "A Morte de Jonathan Moore",
        ],
      },
    ],

    trailer: {
      url: "https://www.youtube.com/embed/mn0QvmEicIY?si=M8RaC2FWAgqPdh8U",
      info: [
    ...
    resenha: {
      ...
      reviews: [
        {
          autor: "TV Guide",
          texto: "Joe Goldberg is the villain we love to hate.",
        },
  ...
  /* ========== o jogo da morte ========== */
  {
    ...
    tipo: "serie",
    popular: true,
    imagem: "assets/img/series/deaths-game.jpg",
    capa: "assets/img/capas-series/deaths-game-capa.jpg",
    tempo: "1 Temporada",
    ano: "2023 - 2024",
    genero: ["Fantasia", "Suspense", "Drama", "Thriller"],
    dataGenre: "kdrama drama fantasia suspense thriller ",
    linkPlataforma:
      "https://www.primevideo.com/detail?gti=amzn1.dv.gti.a3b03bc3-0b7d-49e5-8eb1-6d80ac89dd13&irclickid=6e295544N59f811f1a4259bd2328cca6&ref=dvm_ass_acm_xx_mf_s_imp_6e295544N59f811f1a4259bd2328cca6&irgwc=1&afsrc=1",
    descricao:
    ...
    trailer: {
      url: "https://www.youtube.com/embed/yRdJZD3kP5k?si=d_TkLNQAAApVlLWj",
      info: [
        { titulo: "Diretor", valor: "Ha Byung-hoon" },
        { titulo: "Baseado em", valor: "Webtoon 'I'll Die Soon'" },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Coreano, Português (BR), Inglês",
        },
        { titulo: "Legendas", valor: "20+ idiomas" },
      ],
    },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Uma lição de vida disfarçada de suspense frenético. Death's Game é profundo, visceral e visualmente impecável.",
        },
        {
          autor: "K-Drama_Zone",
          texto:
            "O roteiro é brilhante. A forma como todas as 12 vidas se conectam no final é de explodir a cabeça.",
        },
        {
          autor: "dorameira_expert",
          texto:
            "Prepare o lenço para os episódios finais. É muito mais do que apenas um jogo, é sobre o valor da vida.",
        },
      ],
    },
  ...
  /* ========== stranger things ========== */
  {
    ...
    tipo: "serie",
    popular: true,
    imagem: "assets/img/series/stranger-things.jpg",
    capa: "assets/img/capas-series/stranger-things-capa.jpg",
    tempo: "4 Temporadas",
    ano: "2016 - Presente",
    ...
    trailer: {
      url: "https://www.youtube.com/embed/b9EkMc79ZSU?si=18NOsxLiXqqy4k2lhttps://www.youtube.com/embed/mnd7sUp5qRE",
      info: [
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Influências",
          valor: "Stephen King, Steven Spielberg, John Carpenter",
        },
        { titulo: "Distribuição", valor: "Netflix" },
      ],
      funFacts: [
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "A nostalgia dos anos 80 nunca foi tão bem explorada. Um elenco infantil fenomenal e um roteiro cativante.",
        },
        {
          autor: "Omelete",
          texto:
            "Stranger Things é o maior sucesso da era do streaming por um motivo: personagens que amamos em situações épicas.",
        },
        {
          autor: "vecna_stalker",
          texto:
            "A quarta temporada elevou o nível do terror. Vecna é o melhor vilão que a série já teve.",
        },
      ],
    },
  ...
  /* ========== scarpetta ========== */
  {
    ...
    tipo: "serie",
    popular: true,
    imagem: "assets/img/series/scarpetta.jpg",
    capa: "assets/img/capas-series/scarpetta-capa.jpg",
    tempo: "1 Temporada",
    ano: "2026",
    genero: ["Crime", "Drama", "Mistério", "Suspense"],
    dataGenre: "crime drama misterio suspense",
    linkPlataforma:
      "https://www.primevideo.com/detail?gti=amzn1.dv.gti.358fabf4-c832-4266-b8af-4e2a63d63961&irclickid=6e295544N59f811f1a4259bd2328cca6&ref=dvm_ass_acm_xx_mf_s_imp_6e295544N59f811f1a4259bd2328cca6&irgwc=1&afsrc=1",
    descricao:
    ...
    trailer: {
      url: "https://www.youtube.com/embed/XdP1bTCRA-E?si=ebeVThJxpHiMbdlmhttps://www.youtube.com/embed/ScarpettaTeaser2026",
      info: [
        { titulo: "Showrunner", valor: "Liz Sarnoff" },
        { titulo: "Baseado em", valor: "Série literária de Patricia Cornwell" },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Espanhol, Italiano",
        },
        { titulo: "Legendas", valor: "20+ idiomas" },
      ],
    },
      ...
      reviews: [
        {
          ...
          texto:
            "A química entre Kidman e Curtis como irmãs rivais é o coração pulsante deste suspense investigativo.",
        },
        {
          autor: "Variety",
          texto:
            "Finalmente uma adaptação à altura do legado de Patricia Cornwell. Sombria, inteligente e necessária.",
        },
        {
          autor: "forensic_fan",
          texto:
            "Li todos os livros e ver a Kay Scarpetta ganhando vida com essa produção é um sonho realizado.",
        },
      ],
    },
  ...
  /* ========== one piece ========== */
  {
    ...
    tipo: "serie",
    popular: true,
    imagem: "assets/img/series/one-piece.jpg",
    capa: "assets/img/capas-series/one-piece-capa.jpg",
    tempo: "1 Temporada",
    ano: "2023 - Presente",
    ...
    trailer: {
      url: "https://www.youtube.com/embed/YC8SLpnxsL4?si=EI6cQ2FT4P3VFQ1n",
      info: [
        { titulo: "Showrunners", valor: "Matt Owens • Steven Maeda" },
        { titulo: "Criador Original", valor: "Eiichiro Oda" },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Japonês, Espanhol",
        },
        { titulo: "Legendas", valor: "30+ idiomas" },
      ],
    },
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Local de Produção",
          valor: "Cidade do Cabo (África do Sul)",
        },
        { titulo: "Status", valor: "Renovada para a 2ª Temporada" },
        { titulo: "Idioma Original", valor: "Inglês" },
        { titulo: "Distribuição", valor: "Netflix" },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "A maldição dos live-actions de anime foi finalmente quebrada. Uma adaptação feita com amor e respeito.",
        },
        {
          autor: "Omelete",
          texto:
            "Iñaki Godoy é a personificação do Luffy. O elenco tem uma química que transborda da tela.",
        },
        {
          autor: "nakama_fan",
          texto:
            "Eu estava com medo, mas a série entregou tudo! O Baratie ficou idêntico ao que eu imaginava.",
        },
      ],
    },
  ...
  /* ========== boyfriend on demand ========== */
  {
    ...
    tipo: "serie",
    popular: true,
    imagem: "assets/img/series/boyfriend-on-demand.jpg",
    capa: "assets/img/capas-series/boyfriend-on-demand-capa.jpg",
    tempo: "1 Temporada",
    year: "2019",
    ...
    trailer: {
      url: "https://www.youtube.com/embed/A0GqKTgSpuE?si=J6gg2EtRo_ULpb9d",
      info: [
      ...
      reviews: [
        {
          autor: "MyDramaList",
          texto:
            "Curto, doce e viciante. Uma ótima opção para quem quer um romance leve sem muito drama pesado.",
        },
        {
          autor: "dorameira_sweet",
          texto:
            "A química dos protagonistas é muito fofa! Queria que os episódios fossem mais longos.",
        },
        {
          autor: "kdrama_bites",
          texto:
            "Perfeito para maratonar em uma tarde. O conceito do aplicativo é bem divertido.",
        },
      ],
    },
  ...
  /* ========== young sherlock ========== */
  {
    ...
    tipo: "serie",
    popular: true,
    imagem: "assets/img/series/young-sherlock.jpg",
    capa: "assets/img/capas-series/young-sherlock-capa.jpg",
    tempo: "1 Temporada",
    ano: "2025 - Presente",
    genero: ["Mistério", "Crime", "Ação", "Drama"],
    dataGenre: "aventura acao misterio suspense",
    linkPlataforma:
      "https://www.primevideo.com/detail?gti=amzn1.dv.gti.66761870-19ec-47fe-94c2-8278dc11f40d&irclickid=6e295544N59f811f1a4259bd2328cca6&ref=dvm_ass_acm_xx_mf_s_imp_6e295544N59f811f1a4259bd2328cca6&irgwc=1&afsrc=1",
    descricao:
    ...
    trailer: {
      url: "https://www.youtube.com/embed/XTms-zeUwok?si=9roFPjAEu51Ia2HS",
      info: [
      ...
      reviews: [
        {
          ...
          texto:
            "Uma reimaginação energética e estilosa. Guy Ritchie traz sua assinatura visual para a juventude de Holmes.",
        },
        {
          autor: "Variety",
          texto:
            "Hero Fiennes Tiffin entrega um Sherlock vulnerável e feroz. A química com o elenco veterano é excelente.",
        },
        {
          autor: "detective_lover_22",
          texto:
            "Finalmente uma série que mostra como o Sherlock aprendeu a lutar e a pensar. Ansioso demais!",
        },
      ],
    },
  ...
  /* ========== the man in the high castle ========== */
  {
    ...
    tipo: "serie",
    popular: true,
    imagem: "assets/img/series/the-man-in-the-high-castle.jpg",
    capa: "assets/img/capas-series/the-man-in-the-high-castle-capa.jpg",
    tempo: "4 Temporadas",
    ano: "2015 - 2019",
    ...
    temporadas_detalhes: [
      ...
      },
      {
        ...
        capitulos: [
          "Hexagrama 64",
          "Cada Porta tem uma Chave",
          "A Caixa",
          "Felizes para Sempre",
          "Mau Auspício",
          "Toda a Força",
          "Domínio",
          "Hitler tem apenas um Testículo",
          "Para o Alto",
          "Deuses do Fogo",
        ],
      },
    ...
    trailer: {
      ...
      info: [
        ...
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Japonês, Alemão",
        },
        { titulo: "Legendas", valor: "30+ idiomas" },
      ],
    },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Uma aula de construção de mundo. É aterrorizante ver como o cotidiano seria moldado sob regimes totalitários.",
        },
        {
          autor: "Omelete",
          texto:
            "Rufus Sewell entrega uma das melhores atuações da TV como John Smith, um vilão extremamente complexo.",
        },
        {
          autor: "sci_fi_lover",
          texto:
            "A trama das realidades alternativas e os filmes é o que me prendeu do começo ao fim. Recomendo muito!",
        },
      ],
    },
  ...
  /* ========== alice in the bordeland ========== */
  {
    id: "alice_in_borderland",
    titulo: "Alice in Borderland",
    popular: true,
    tipo: "serie",
    imagem: "assets/img/series/alice-in-borderland.jpg",
    capa: "assets/img/capas-series/alice-in-borderland-capa.jpg",
    tempo: "2 Temporadas",
    ano: "2020 - Presente",
    ...
    trailer: {
      ...
      info: [
        ...
        {
          titulo: "Idiomas Disponíveis",
          valor: "Japonês, Português (BR), Inglês",
        },
        { titulo: "Legendas", valor: "30+ idiomas" },
      ],
    },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Visualmente impecável e desesperador. Uma das melhores adaptações de mangá já feitas para a TV.",
        },
        {
          autor: "Omelete",
          texto:
            "Os jogos mentais do Chishiya são o ponto alto da segunda temporada. Roteiro inteligente e tenso.",
        },
        {
          autor: "survival_expert",
          texto:
            "O jogo do Sete de Copas na primeira temporada é uma das coisas mais tristes e viscerais que já vi.",
        },
      ],
    },
  ...
  /* ========== the pitt ========== */
  {
    ...
    tipo: "serie",
    popular: true,
    imagem: "assets/img/series/the-pitt.jpg",
    capa: "assets/img/capas-series/the-pitt-capa.jpg",
    tempo: "1 Temporada",
    ano: "2025 - 2026",
    genero: ["Drama", "Médico"],
    dataGenre: "drama medico",
    linkPlataforma:
      "https://play.hbomax.com/video/watch/e4b915fb-5e6b-42b8-97ac-90ec7d0e3147?utm_source=universal_search",
    descricao:
    ...
    trailer: {
      url: "https://www.youtube.com/embed/2Y6dp7EPjm0?si=oOBLDVTI9AXKlGYK",
      info: [
      ...
      reviews: [
        {
          autor: "Variety",
          texto:
            "Noah Wyle prova que ainda é o rei dos dramas médicos. Uma atuação sóbria e poderosa em um ambiente caótico.",
        },
        {
          autor: "The Hollywood Reporter",
          texto:
            "Cru, realista e necessário. The Pitt não tem medo de mostrar as rachaduras no sistema de saúde americano.",
        },
        {
          autor: "hospital_drama_fan",
          texto:
            "Estava com saudades de um drama médico que realmente focasse na rotina do hospital sem tanto 'mimimi'. Nota 10!",
        },
      ],
    },
  ...
  /* ========== o agente noturno ========== */
  {
    ...
    tipo: "serie",
    popular: true,
    imagem: "assets/img/series/the-night-agent.jpg",
    capa: "assets/img/capas-series/the-night-agent-capa.jpg",
    tempo: "2 Temporadas",
    ano: "2023 - Presente",
    ...
    trailer: {
      url: "https://www.youtube.com/embed/cDpNFQWeqpo?si=t_iq-meiL1aEnD2Y",
      info: [
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Local de Produção",
          valor: "Vancouver (Canadá), Bangkok (Tailândia)",
        },
        { titulo: "Status", valor: "Renovada para a 3ª Temporada" },
        { titulo: "Idioma Original", valor: "Inglês" },
        { titulo: "Distribuição", valor: "Netflix" },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Um thriller de espionagem raiz. Ritmo frenético que te faz querer maratonar tudo em um único dia.",
        },
        {
          autor: "Omelete",
          texto:
            "Gabriel Basso traz um carisma de herói de ação clássico para um roteiro moderno e cheio de reviravoltas.",
        },
        {
          autor: "action_spy_fan",
          texto:
            "Finalmente um agente secreto que parece real e falível. A química com a Rose é o que mantém a série humana.",
        },
      ],
    },
  ...
  /* ========== breaking bad ========== */
  {
    ...
    titulo: "Breaking Bad",
    tipo: "serie",
    imagem: "assets/img/series/breakingbad.jpg",
    capa: "assets/img/capas-series/breakingbad-capa.jpg",
    tempo: "5 Temporadas",
    ano: "2008 - 2013",
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Local de Produção",
          valor: "Albuquerque, Novo México (EUA)",
        },
        { titulo: "Status", valor: "Finalizada" },
        { titulo: "Idioma Original", valor: "Inglês" },
        { titulo: "Distribuição", valor: "Netflix" },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Roteiro perfeito, atuações viscerais e uma transformação de personagem que nunca será superada. Obra-prima.",
        },
        {
          autor: "IMDb",
          texto:
            "O episódio 'Ozymandias' é frequentemente citado como o melhor episódio da história da televisão.",
        },
        {
          autor: "heisenberg_fan",
          texto:
            "Eu assisti três vezes e cada vez percebo um detalhe novo. 'Say my name' é de arrepiar!",
        },
      ],
    },
  ...
  /* ========== game of thrones ========== */
  {
    ...
    tipo: "serie",
    imagem: "assets/img/series/game-of-thrones.jpg",
    capa: "assets/img/capas-series/game-of-thrones-capa.jpg",
    tempo: "8 Temporadas",
    ano: "2011 - 2019",
    genero: ["Fantasia", "Drama", "Ação", "Aventura"],
    dataGenre: "fantasia acao drama",
    linkPlataforma:
      "https://play.hbomax.com/video/watch/83eca32a-12d2-4e05-8245-e17855c9e390?utm_source=universal_search",
    descricao:
    ...
    temporadas_detalhes: [
      {
        ...
        capitulos: [
          ...
          "A Estrada do Rei",
          "Lord Snow",
          "Criplos, Bastardos e Coisas Quebradas",
          "O Lobo e o Leão",
          "Uma Coroa de Ouro",
          "Vencer ou Morrer",
          "O Lado Pontudo",
      ...
      },
      {
        ...
        capitulos: [
          "O Norte se Lembra",
          "As Terras da Noite",
          "O Que Morto Não Pode Morrer",
          "Jardim de Ossos",
          "O Fantasma de Harrenhal",
          "O Velhos Deuses e os Novos",
          "Um Homem Sem Honra",
      ...
      },
      {
        ...
        capitulos: [
          ...
          "A Caminhada da Punição",
          "E Agora Sua Patrulha Terminou",
          "Beijada pelo Fogo",
          "A Escalada",
          "Os Segundos Filhos",
    ...
    trailer: {
      ...
      info: [
        ...
        {
          titulo: "Baseado em",
          valor: "As Crônicas de Gelo e Fogo de George R.R. Martin",
        },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Espanhol",
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Local de Produção",
          valor: "Irlanda do Norte, Croácia, Islândia, Espanha",
        },
        { titulo: "Status", valor: "Finalizada" },
      ...
      reviews: [
        {
          ...
          texto:
            "Uma experiência televisiva sem precedentes. Game of Thrones redefiniu o que é possível fazer em uma série de TV.",
        },
        {
          autor: "Omelete",
          texto:
            "Mesmo com o final divisivo, a jornada de Westeros é obrigatória para qualquer fã de fantasia épica.",
        },
        {
          autor: "stark_forever",
          texto:
            "O Casamento Vermelho mudou minha vida. Nunca senti tanta dor assistindo a uma série, mas amei cada segundo.",
        },
      ],
    },
  ...
  /* ========== the last of us ========== */
  {
    ...
    tipo: "serie",
    imagem: "assets/img/series/the-last-of-us.jpg",
    capa: "assets/img/capas-series/the-last-of-us-capa.jpg",
    tempo: "2 Temporadas",
    ano: "2023 - 2025",
    genero: ["Drama", "Pós-Apocalíptico", "Terror", "Ação"],
    dataGenre: "drama acao sci-fi",
    linkPlataforma:
      "https://play.hbomax.com/video/watch/c07ae042-082e-4b53-ba86-b6ac5e3004db?utm_source=universal_search",
    descricao:
    ...
    trailer: {
      url: "https://www.youtube.com/embed/lW5kiEUVlpo?si=U7MM5Wh6cV02lpF4",
      info: [
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Direção T2",
          valor: "Mark Mylod, Nina Lopez-Corrado, Stephen Williams",
        },
        { titulo: "Distribuição", valor: "Max (HBO)" },
      ],
      funFacts: [
      ...
      reviews: [
        {
          autor: "Variety",
          texto:
            "Uma sequência corajosa e dolorosa. A série não foge das decisões difíceis do material original.",
        },
        {
          autor: "The Guardian",
          texto:
            "Bella Ramsey entrega uma atuação digna de prêmios nesta temporada, mostrando o lado sombrio de Ellie.",
        },
        {
          autor: "gamer_legacy",
          texto:
            "É difícil de assistir por causa da carga emocional, mas é cinema puro. Fiel até nos mínimos detalhes.",
        },
      ],
    },
  ...
  /* ========== la casa de papel ========== */
  {
    ...
    tipo: "serie",
    imagem: "assets/img/series/la-casa-de-papel.jpg",
    capa: "assets/img/capas-series/la-casa-de-papel-capa.jpg",
    tempo: "5 Partes",
    ano: "2017 - 2021",
    ...
    temporadas_detalhes: [
      ...
      },
      {
        ...
        capitulos: [
          "Estamos de Volta",
          "Aiwa",
          "48 Metros Abaixo da Terra",
          "Bum, Bum, Ciao",
          "As Caixas Vermelhas",
          "Tudo Parecia sem Saída",
          "Férias",
          "Deriva",
        ],
      },
      ...
      },
      {
        ...
        capitulos: [
          ...
          "Válvula de Escape",
          "Ciência Iludida",
          "A Teoria da Elegância",
          "O que se Conversa na Cama",
    ...
    trailer: {
      url: "https://www.youtube.com/embed/iS5xXr-GOnM?si=LYUtgSY5o17IuJGx",
      info: [
        { titulo: "Criador", valor: "Álex Pina" },
        { titulo: "Idioma Original", valor: "Espanhol" },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Espanhol, Português (BR), Inglês",
        },
        { titulo: "Legendas", valor: "35+ idiomas" },
      ],
    },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Um jogo de xadrez eletrizante onde o Professor está sempre um passo à frente.",
        },
        {
          autor: "Omelete",
          texto:
            "Tensão constante e personagens apaixonantes que fazem você torcer pelos 'vilões'.",
        },
        {
          autor: "bella_ciao_fan",
          texto:
            "Nairóbi é a melhor personagem de todas. O plano do ouro é ainda mais louco que o da moeda!",
        },
      ],
    },
  ...
  /* ========== wandinha ========== */
  {
    ...
    titulo: "Wandinha",
    tipo: "serie",
    imagem: "assets/img/series/wandinha.jpg",
    capa: "assets/img/capas-series/wandinha-capa.jpg",
    tempo: "2 Temporadas",
    ano: "2022 - Presente",
    ...
    trailer: {
      url: "https://www.youtube.com/embed/xvJL6qQ249A?si=_4FHZCZczLA04Qck",
      info: [
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Jenna Ortega nasceu para esse papel. O tom gótico de Tim Burton brilha em cada frame.",
        },
        {
          autor: "The Guardian",
          texto:
            "Uma mistura perfeita de mistério adolescente com o humor ácido da Família Addams.",
        },
        {
          autor: "enid_fan_club",
          texto:
            "A amizade da Enid e da Wandinha é a melhor coisa da série! A segunda temporada está ainda mais assustadora.",
        },
      ],
    },
  ...
  /* ========== the boys ========== */
  {
    ...
    titulo: "The Boys",
    tipo: "serie",
    imagem: "assets/img/series/the-boys.jpg",
    capa: "assets/img/capas-series/the-boys-capa.jpg",
    tempo: "5 Temporadas",
    ano: "2019 - 2026",
    genero: ["Ação", "Sátira", "Ficção Científica", "Drama"],
    dataGenre: "acao comedia sci-fi",
    linkPlataforma:
      "https://www.primevideo.com/detail?gti=amzn1.dv.gti.9ab600aa-6625-b547-cfc0-190e3ad8a27d&irclickid=6e295544N59f811f1a4259bd2328cca6&ref=dvm_ass_acm_xx_mf_s_imp_6e295544N59f811f1a4259bd2328cca6&irgwc=1&afsrc=1",
    descricao:
    ...
    temporadas_detalhes: [
      {
        ...
        capitulos: [
          ...
          "Bom para a Alma",
          "Os Inocentes",
          "A Sociedade da Autopreservação",
          "Você Me Encontrou",
        ],
      },
      {
        ...
        capitulos: [
          ...
          "Mil Homens com Armas de Prata",
          "Nada como um Bom Lar",
          "Temos que Ir Agora",
          "O Sangue nas Portas",
          "O Carniceiro, o Padeiro e o Candeeiro",
          "O Que Eu Sei",
        ],
      },
      {
        ...
        capitulos: [
          "Retorno",
          "A Única Pessoa no Céu",
          "Costa de Barbary",
          "Plano de Cinco Anos",
          "A Última Vez para Olhar para este Mundo de Mentiras",
          "Herogasm",
          "Aqui Vem uma Vela para Iluminar Você até a Cama",
          "O Instante de Sangue e Poeira",
        ],
      },
      {
        numero: "Temporada 4",
        capitulos: [
          "Departamento de Estratégias Sujas",
          "Vida entre os Canibais",
          "Vamos Colocar a Bandeira do Medo",
          "A Sabedoria dos Velhos",
          "Cuidado com o Jabberwock, Meu Filho",
          "Transe Sujo",
          "A Pessoa de Dentro",
          "Temporada de Assassinatos",
        ],
      },
      {
        numero: "Temporada 5",
      ...
      reviews: [
        {
          autor: "Rotten Tomatoes",
          texto:
            "Uma sátira brutalmente honesta e sangrenta sobre o poder e o fascismo disfarçados de heroísmo.",
        },
        {
          autor: "Omelete",
          texto:
            "The Boys é o antídoto perfeito para a fadiga de filmes de super-heróis convencionais.",
        },
        {
          autor: "vought_leaks",
          texto:
            "Butcher é o melhor anti-herói já feito. A quinta temporada fechou com chave de ouro e muito sangue!",
        },
      ],
    },
  ...
  /* ========== the walking dead ========== */
  {
    ...
    tipo: "serie",
    imagem: "assets/img/series/the-walking-dead.jpg",
    capa: "assets/img/capas-series/the-walking-dead-capa.jpg",
    tempo: "11 Temporadas",
    ano: "2010 - 2022",
    ...
    temporadas_detalhes: [
      ...
      },
      {
        ...
        capitulos: [
          ...
          "Hostis e Calamidades",
          "Diga Sim",
          "Enterre-me Aqui",
          "O Outro Lado",
          "Algo de que Eles Precisam",
      ...
      },
      {
        ...
        capitulos: [
          ...
          "Monstros",
          "Algum Cara",
          "O Grande e Assustador 'Ele'",
          "O Rei, a Viúva e o Rick",
          "Chegou a Hora",
          "Como Tem que Ser",
          "Honra",
          "Os Perdidos e os Saqueadores",
          "Mortos ou Vivos ou...",
          "A Chave",
          "Não Nos Deixe Desviar",
          "Vale Tudo",
          "Vale a Pena",
          "Ira",
        ],
    ...
    trailer: {
      ...
      info: [
        {
          titulo: "Showrunners",
          valor: "Frank Darabont / Scott M. Gimple / Angela Kang",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
        {
          titulo: "Idiomas Disponíveis",
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Status",
          valor: "Finalizada (Universo Expandido em andamento)",
        },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Um marco cultural. Mais do que uma série de terror, é um estudo sobre a natureza humana sob pressão extrema.",
        },
        {
          autor: "IMDb",
          texto:
            "As primeiras temporadas são o auge da TV de sobrevivência. O desenvolvimento de Rick Grimes é lendário.",
        },
        {
          autor: "twdfan_99",
          texto:
            "O Negan é o vilão mais carismático que já existiu. Chorei no final da série, foi um encerramento digno!",
        },
      ],
    },
  ...
  /* ========== friends ========== */
  {
    ...
    titulo: "Friends",
    tipo: "serie",
    imagem: "assets/img/series/friends.jpg",
    capa: "assets/img/capas-series/friends-capa.jpg",
    tempo: "10 Temporadas",
    ano: "1994 - 2004",
    genero: ["Comédia", "Romance"],
    dataGenre: "comedia romance",
    linkPlataforma:
      "https://play.hbomax.com/video/watch/0e33e070-5a45-425a-b655-9d7a7a6658ba?utm_source=universal_search",
    descricao:
    ...
    temporadas_detalhes: [
      {
        ...
        capitulos: [
          ...
          "Aquele com o Ultrassom no Final",
          "Aquele com o Polegar",
          "Aquele com o George Stephanopoulos",
          "Aquele com o Detergente para Roupa da Alemanha Oriental",
          "Aquele com o Bumbum",
          "Aquele com o Blecaute",
          "Aquele em que Nana Morre Duas Vezes",
          "Aquele em que Underdog Escapa",
          "Aquele com o Macaco",
          "Aquele com a Sra. Bing",
          "Aquele com as Dezenas de Lasanhas",
          "Aquele com os Seios",
          "Aquele com os Doces Doces",
          "Aquele com o Cara do Desentupidor",
          "Aquele com Duas Partes: Parte 1",
          "Aquele com Duas Partes: Parte 2",
          "Aquele com o Pôquer",
          "Aquele com o Macaco Fugitivo",
          "Aquele com o Ortodontista Masoquista",
          "Aquele com o Convite Falso",
          "Aquele com o Fator Nojinho",
      ...
      },
      {
        numero: "Temporada 2",
        capitulos: [
          "Aquele com o Novo Namorado da Rachel",
      ...
      },
      {
        ...
        capitulos: [
          ...
          "Aquele com o Jam",
          "Aquele com o Metrônomo",
          "Aquele com o Irmão da Phoebe",
          "Aquele com o Flashback",
          "Aquele com o Carro de Corrida",
          "Aquele com o Futebol Americano",
          "Aquele com a Garota de Poughkeepsie",
          "Aquele com o Número de Rachel",
          "Aquele com Chandler Não Consegue Lembrar Qual Irmã",
          "Aquele com Todo o Ciúme",
          "Aquele em que Monica e Richard são Apenas Amigos",
          "Aquele com a Ex-Mulher de Phoebe",
          "Aquele em que Ross e Rachel Dão um Tempo",
          "Aquele da Manhã Seguinte",
          "Aquele sem o Esqui",
          "Aquele com a Fita da Hipnose",
          "Aquele com a Camiseta Minúscula",
          "Aquele com a Casa de Bonecas",
          "Aquele com o Pintinho e o Pato",
          "Aquele com o Grito",
          "Aquele com a Coisa do Ross",
          "Aquele com o Campeão de Luta Definitiva",
          "Aquele na Praia",
        ],
      },
      {
        ...
        capitulos: [
          ...
          "Aquele com a Dança de Salão",
          "Aquele com o Novo Namorado da Phoebe",
          "Aquele com a Garota Suja",
          "Aquele em que Chandler Atravessa a Linha",
          "Aquele com Chandler no Caixote",
          "Aquele com Todos os Doces",
          "Aquele com a Garota de Poughkeepsie",
          "Aquele com o Útero da Phoebe",
          "Aquele com os Embriões",
          "Aquele com a Rachel Apaixonada",
          "Aquele com o Dirty Day do Joey",
          "Aquele com o Rugby",
          "Aquele com a Festa Falsa",
          "Aquele com a Entrega Grátis",
          "Aquele com o Vestido de Noiva",
          "Aquele com o Convite",
          "Aquele com o Vestido Novo da Rachel",
          "Aquele com o Pior Padrinho do Mundo",
          "Aquele com o Casamento do Ross: Parte 1",
          "Aquele com o Casamento do Ross: Parte 2",
        ],
      },
      {
        numero: "Temporada 5",
        capitulos: [
          ...
          "Aquele com o Ketchup Triplo",
          "Aquele em que Phoebe dá à Luz",
          "Aquele com o Erro do Joey",
          "Aquele com o Pé do Papai Noel",
          "Aquele em que Ross se Muda",
          "Aquele com Todos os Dias de Ação de Graças",
          "Aquele com o Sanduíche do Ross",
          "Aquele com a Risada Inapropriada",
          "Aquele com as Resoluções",
          "Aquele com a Risada de Trabalho do Chandler",
          "Aquele em que Joey Descobre",
          "Aquele em que Todos Descobrem",
          "Aquele com a Garota que Bate no Joey",
          "Aquele com o Policial",
          "Aquele com o Inadvertido Beijo da Rachel",
          "Aquele com a Rachel Fumante",
          "Aquele em que Ross Não Consegue Flertar",
          "Aquele com a Carona",
          "Aquele com a Balada da Rachel",
          "Aquele com o Olho do Joey",
          "Aquele em Vegas: Parte 1",
          "Aquele em Vegas: Parte 2",
        ],
      },
      {
        numero: "Temporada 6",
        capitulos: [
          ...
          "Aquele em que Ross Abraça a Rachel",
          "Aquele com a Negação do Ross",
          "Aquele em que Joey Perde o Convênio",
          "Aquele com o Porsche do Porsche",
          "Aquele na Última Noite",
          "Aquele em que Phoebe Corre",
          "Aquele com os Dentes do Ross",
          "Aquele em que Ross Fica Doidão",
          "Aquele com a Rotina",
          "Aquele com a Mesa de Boticário",
          "Aquele da Piada",
          "Aquele com a Irmã da Rachel",
          "Aquele em que Chandler Não Consegue Chorar",
          "Aquele que Poderia Ter Sido: Parte 1",
          "Aquele que Poderia Ter Sido: Parte 2",
          "Aquele com o Unagi",
          "Aquele em que o Mac de Joey é Atropelado",
          "Aquele com a Geladeira do Joey",
          "Aquele com o Mac de Joey",
          "Aquele em que Ross Conhece o Pai de Elizabeth",
          "Aquele em que o Paul é o Cara",
          "Aquele com o Anel",
      ...
      },
      {
        numero: "Temporada 7",
        capitulos: [
          "Aquele com o Trovão da Monica",
          "Aquele com o Livro da Rachel",
          "Aquele com os Cookies da Phoebe",
          "Aquele com o Assistente da Rachel",
          "Aquele com a Foto de Noivado",
          "Aquele com a Biblioteca do Ross",
          "Aquele com o Livro de Erros do Ross",
          "Aquele em que Chandler Não Gosta de Cachorros",
          "Aquele com todos os Doces de Natal",
          "Aquele com o Tatu de Natal",
          "Aquele com os Cheesecakes",
          "Aquele em que Eles Ficam Acordados a Noite Toda",
          "Aquele em que Rosita Morre",
          "Aquele com o Trinta Anos da Rachel",
          "Aquele com o Novo Cérebro do Joey",
          "Aquele com a Verdade sobre Londres",
          "Aquele com o Vestido Barato da Monica",
          "Aquele com o Prêmio do Joey",
          "Aquele com a Prima do Ross",
          "Aquele com o Voto da Rachel",
          "Aquele com o Pai do Chandler",
          "Aquele com o Casamento da Monica e do Chandler: Parte 1",
          "Aquele com o Casamento da Monica e do Chandler: Parte 2",
        ],
      },
      {
        numero: "Temporada 8",
        capitulos: [
          ...
          "Aquele em que Rachel Conta ao Ross",
          "Aquele com o Videotape",
          "Aquele com o Encontro da Rachel",
          "Aquele com a Festa de Halloween",
          "Aquele com a Mancha",
          "Aquele com a Stripper",
          "Aquele com o Boato",
          "Aquele com as Botas da Monica",
          "Aquele com o Chá de Bebê da Rachel",
          "Aquele em que Joey Namora a Rachel",
          "Aquele em que Chandler Toma Banho de Banheira",
          "Aquele com o Desejo da Rachel",
          "Aquele com o Vídeo do Parto",
          "Aquele em que Joey Conta para a Rachel",
          "Aquele com as Folhas de Chá",
          "Aquele em que o Joey está em Choque",
          "Aquele com o Aniversário de Casamento",
          "Aquele com o Chá de Bebê",
          "Aquele com a Aula de Culinária",
          "Aquele em que Rachel Está Atrasada",
          "Aquele em que Rachel tem o Bebê: Parte 1",
          "Aquele em que Rachel tem o Bebê: Parte 2",
        ],
      },
      {
        numero: "Temporada 9",
        capitulos: [
          "Aquele em que Ninguém Propõe",
          "Aquele com o Sono da Emma",
          "Aquele com o Pediatra",
          "Aquele com os Tubarões",
          "Aquele com o Jantar de Aniversário da Phoebe",
          "Aquele com a Babá Homem",
          "Aquele com a Canção Inapropriada do Ross",
          "Aquele com a Outra Irmã da Rachel",
          "Aquele com o Bilhete Premiado",
          "Aquele com o Natal em Tulsa",
          "Aquele em que a Rachel Volta a Trabalhar",
          "Aquele com a Ratazana da Phoebe",
          "Aquele em que Monica Canta",
          "Aquele com o Encontro às Cegas",
          "Aquele com o Assalto",
          "Aquele com o E-mail de Sacanagem",
          "Aquele com o Memorial",
          "Aquele com a Loteria",
          "Aquele com o Sonho da Rachel",
          "Aquele com a Festa na Sabatina",
          "Aquele com o Teste de Fertilidade",
          "Aquele com o Doador",
          "Aquele em Barbados: Parte 1",
          "Aquele em Barbados: Parte 2",
        ],
      },
      {
        numero: "Temporada 10",
        capitulos: [
          "Aquele depois do Beijo do Joey e da Rachel",
          "Aquele em que Ross Fica Doidão",
          "Aquele com o Bronzeamento do Ross",
          "Aquele com o Bolo",
          "Aquele em que a Irmã da Rachel Toma conta do Bebê",
          "Aquele com a Subvenção do Ross",
          "Aquele com o Estudo de Casa",
          "Aquele com o Ação de Graças Tardio",
          "Aquele com a Mãe Biológica",
          "Aquele em que o Pai do Chandler Chora",
          "Aquele em que a Stripper Chora",
          "Aquele com o Casamento da Phoebe",
          "Aquele em que o Joey Aprende Francês",
          "Aquele com a Princesa Consuela",
          "Aquele em que a Estelle Morre",
          "Aquele com a Festa de Despedida da Rachel",
          "O Último: Parte 1",
          "O Último: Parte 2",
        ],
      },
    ...
    trailer: {
      url: "https://www.youtube.com/embed/Y9eUQWA7HRc?si=dnJfAnGF74W2rheF",
      info: [
        { titulo: "Criadores", valor: "David Crane • Marta Kauffman" },
        {
          titulo: "Música Tema",
          valor: "I'll Be There for You (The Rembrandts)",
        },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Espanhol, Francês",
        },
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Local de Produção",
          valor: "Burbank, Califórnia (Gravado com plateia real)",
        },
        { titulo: "Status", valor: "Finalizada" },
      ...
      reviews: [
        {
          autor: "Rotten Tomatoes",
          texto:
            "Uma das sitcoms mais influentes e amadas de todos os tempos. Conforto em forma de série.",
        },
        {
          autor: "Omelete",
          texto:
            "Mesmo décadas depois, Friends continua relevante e capaz de conquistar novas gerações.",
        },
        {
          autor: "central_perk_fan",
          texto:
            "Eu já assisti 10 vezes e ainda dou risada das mesmas piadas. 'We were on a break!'",
        },
      ],
    },
  ...
  /* ========== the crown ========== */
  {
    ...
    titulo: "The Crown",
    tipo: "serie",
    imagem: "assets/img/series/the-crown.jpg",
    capa: "assets/img/capas-series/the-crown-capa.jpg",
    tempo: "6 Temporadas",
    ano: "2016 - 2023",
    ...
    elenco: [
      {
        ator: "Claire Foy / Olivia Colman / Imelda Staunton",
        personagem: "Rainha Elizabeth II",
      },
      {
        ator: "Matt Smith / Tobias Menzies / Jonathan Pryce",
        personagem: "Príncipe Philip",
      },
      {
        ator: "Vanessa Kirby / Helena Bonham Carter / Lesley Manville",
        personagem: "Princesa Margaret",
      },
      ...
      reviews: [
        {
          autor: "Variety",
          texto:
            "Uma lição de história envolvente, com design de produção impecável e atuações dignas de nota.",
        },
        {
          autor: "The Hollywood Reporter",
          texto:
            "The Crown consegue humanizar figuras que o mundo inteiro conhece apenas por protocolos.",
        },
        {
          autor: "royal_watcher",
          texto:
            "O episódio de Aberfan na 3ª temporada é uma obra-prima de partir o coração. Olivia Colman é perfeita.",
        },
      ],
    },
  ...
  /* ========== black mirror ========== */
  {
    ...
    trailer: {
      url: "https://www.youtube.com/embed/M8qG0vS2zWM?si=ejvaqzwiNQnFSiQI",
      info: [
      ...
      reviews: [
        {
          autor: "Variety",
          texto:
            "Uma visão profética e aterrorizante do nosso relacionamento com a tecnologia.",
        },
        {
          autor: "The Guardian",
          texto:
            "Brooker continua sendo o mestre do desconforto moderno. Cada episódio é um soco no estômago.",
        },
        {
          autor: "tech_distopia",
          texto:
            "O episódio 'Beyond the Sea' da 6ª temporada é cinema puro. Aaron Paul está incrível!",
        },
      ],
    },
  ...
  /* ========== the bear ========== */
  {
    ...
    titulo: "The Bear",
    tipo: "serie",
    imagem: "assets/img/series/the-bear.jpg",
    capa: "assets/img/capas-series/the-bear-capa.jpg",
    tempo: "4 Temporadas",
    ano: "2022 - Presente",
    genero: ["Drama", "Comédia"],
    dataGenre: "drama comedia",
    linkPlataforma:
      "https://www.disneyplus.com/en-br/browse/entity-05eb6a8e-90ed-4947-8c0b-e6536cbddd5f?irclickid=Sfkz5UwfoxyZRUIQAa3FxyzsUkuRdR3POw6KQM0&campaignId=9358&irgwc=1&afsrc=1&cid=DSS-Affiliate-Impact-Content-JustWatch%20GmbH-1172972",
    descricao:
    ...
    trailer: {
      url: "https://www.youtube.com/embed/gBmkI4jlaIo?si=du2cN-AVSiNp6B1N",
      info: [
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Prêmios",
          valor: "Vencedora de múltiplos Emmy e Globos de Ouro",
        },
        { titulo: "Idioma Original", valor: "Inglês" },
      ...
      reviews: [
        {
          autor: "Rolling Stone",
          texto:
            "Um retrato visceral e honesto sobre o estresse na cozinha e o processo de cura através do trabalho.",
        },
        {
          autor: "AdoroCinema",
          texto:
            "Edição frenética e atuações de tirar o fôlego. 'The Bear' redefine o drama televisivo contemporâneo.",
        },
        {
          autor: "chef_luigi_92",
          texto:
            "Finalmente uma série que mostra o caos real de uma cozinha. Sinto a ansiedade em cada 'Yes, Chef!'",
        },
      ],
    },
  ...
  /* ========== narcos ==========*/
  {
    ...
    titulo: "Narcos",
    tipo: "serie",
    imagem: "assets/img/series/narcos.jpg",
    capa: "assets/img/capas-series/narcos-capa.jpg",
    tempo: "3 Temporadas",
    ano: "2015 - 2017",
    ...
    trailer: {
      url: "https://www.youtube.com/embed/xl8zdCY-abw?si=1uxH_wwqIFsSaOL8",
      info: [
        { titulo: "Produtor Executivo", valor: "José Padilha" },
        {
          titulo: "Narração",
          valor: "Steve Murphy (T1-T2) / Javier Peña (T3)",
        },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Espanhol, Inglês, Português (BR)",
        },
        { titulo: "Legendas", valor: "25+ idiomas" },
      ],
    },
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Uma performance magistral de Wagner Moura que humaniza e aterroriza ao mesmo tempo.",
        },
        {
          autor: "The New York Times",
          texto:
            "Viciante, educativa e tecnicamente impecável. O ritmo da terceira temporada prova que a série sobrevive além de Escobar.",
        },
        {
          autor: "plata_o_plomo_fan",
          texto:
            "A abertura 'Tuyo' é a melhor de todas as séries da Netflix. Impossível pular!",
        },
      ],
    },
  ...
  /* ========== euphoria ========== */
  {
    ...
    titulo: "Euphoria",
    tipo: "serie",
    imagem: "assets/img/series/euphoria.jpg",
    capa: "assets/img/capas-series/euphoria-capa.jpg",
    tempo: "3 Temporadas",
    ano: "2019 - Presente",
    genero: ["Drama", "Teen"],
    dataGenre: "drama teen",
    linkPlataforma:
      "https://play.hbomax.com/video/watch/a4c77a14-d711-440f-9907-0afc17f0e2a9?utm_source=universal_search",
    descricao:
    ...
    temporadas_detalhes: [
      ...
      },
      {
        ...
        capitulos: [
          "Trouble Don't Last Always (Rue)",
          "Fuck Anyone Who's Not a Sea Blob (Jules)",
        ],
      },
      {
        numero: "Temporada 2",
    ...
    trailer: {
      url: "https://www.youtube.com/embed/6XGnv7Zgbeg?si=yBIUCs4EhpzvTXpA",
      info: [
      ...
      reviews: [
        {
          autor: "AdoroCinema",
          texto:
            "Uma experiência sensorial. Euphoria usa a estética para traduzir sentimentos que as palavras não alcançam.",
        },
        {
          autor: "Vogue",
          texto:
            "O figurino e a maquiagem são personagens à parte. Uma obra-prima visual da A24.",
        },
        {
          autor: "labrinth_fan",
          texto:
            "A trilha sonora do Labrinth é o que dá alma para essa série. Impossível não se emocionar com as cenas da Rue.",
        },
      ],
    },
  ...
  /* ========== the office ========== */
  {
    ...
    titulo: "The Office",
    tipo: "serie",
    imagem: "assets/img/series/the-office.jpg",
    capa: "assets/img/capas-series/the-office-capa.jpg",
    tempo: "9 Temporadas",
    ano: "2005 - 2013",
    ...
    temporadas_detalhes: [
      ...
      },
      {
        ...
        capitulos: [
          ...
          "Festa de Natal",
          "O Cruzeiro da Bebida",
          "O Ferimento",
          "O Segredo",
          "O Tapete",
          "Meninos e Meninas",
          "O Reclamante",
          "O Aniversário do Dwight",
          "O Dia das Crianças",
          "A Grande Venda",
          "Prova de Drogas",
      ...
      },
      {
        ...
        capitulos: [
          ...
          "A Fusão",
          "O Presidiário",
          "Um Natal à La Benihana",
          "De Volta das Férias",
          "Vendedores Viajantes",
          "O Retorno",
          "Ben Franklin",
          "O Casamento da Phyllis",
          "Negócios é Negócios",
          "Coquetel",
          "O Negociador",
    ...
    trailer: {
      url: "https://www.youtube.com/embed/tNcDHWpselE?si=ChvCbZerJxhim-H-",
      info: [
        { titulo: "Adaptador", valor: "Greg Daniels" },
        {
          titulo: "Criadores Originais",
          valor: "Ricky Gervais • Stephen Merchant",
        },
        {
          titulo: "Idiomas Disponíveis",
          valor: "Inglês, Português (BR), Espanhol",
      ...
      reviews: [
        {
          autor: "Rotten Tomatoes",
          texto:
            "Uma série que começou como uma cópia e se tornou a sitcom definitiva da era moderna.",
        },
        {
          autor: "IMDb",
          texto:
            "Michael Scott é o personagem mais irritante e amável da história da TV. Assista 100 vezes e ainda rirá.",
        },
        {
          autor: "dunder_mifflin_forever",
          texto:
            "O final da série é a coisa mais emocionante que já vi. Chorei como um bebê com a volta do Michael.",
        },
      ],
    },
  ...
  /* ========== bridgerton ========== */
  {
    ...
    titulo: "Bridgerton",
    tipo: "serie",
    imagem: "assets/img/series/bridgerton.jpg",
    capa: "assets/img/capas-series/bridgerton-capa.jpg",
    tempo: "4 Temporadas",
    ano: "2020 - Presente",
    ...
    sobre: {
      info: [
        ...
        {
          titulo: "Spin-off",
          valor: "Rainha Charlotte: Uma História Bridgerton",
        },
        { titulo: "Distribuição", valor: "Netflix" },
      ],
      funFacts: [
      ...
      reviews: [
        {
          autor: "Vogue",
          texto:
            "Um banquete visual. Bridgerton reinventa o drama de época com diversidade, cores e muito romance.",
        },
        {
          autor: "AdoroCinema",
          texto:
            "Viciante do início ao fim. A química entre os protagonistas de cada temporada é o grande trunfo da série.",
        },
        {
          autor: "lady_w_fan",
          texto:
            "Benedict finalmente teve sua vez na 4ª temporada! A espera pelo baile de máscaras valeu muito a pena.",
        },
      ],
    },
